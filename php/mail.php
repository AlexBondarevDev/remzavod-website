...
require_once('/var/www/remzavod/data/www/remzavodstan.ru/php/phpmailer/PHPMailerAutoload.php');
$mail = new PHPMailer;
$mail->CharSet = 'utf-8';
...
$mail->Password = 'c9sNnQV9n7ntak2v8msm'; // Ваш пароль от почты с которой будут отправляться письма
